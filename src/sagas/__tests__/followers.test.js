...
describe('Сага followers', () => {
    ...
    it('если нет ошибок, должен отправляться action fetchUserSuccess с followers', () => {
    ...
    it('если произошла ошибка, должен отправляться action fetchUserFailure с ошибкой', () => {
